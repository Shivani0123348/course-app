                ...
                <div className="relative flex-shrink-0 w-92 transition-transform duration-300 transform hover:scale-105">
                  <div className="bg-gray-900 rounded-lg overflow-hidden">
                    ...
                    <div className="p-6 text-center">
                      ...
                      {isLoggedIn&& <Link to={`/buy/${course._id}`} className="mt-8 bg-orange-500 text-white py-2 px-4 rounded-full hover:bg-blue-500 duration-300">
                     Enroll Now
                      </Link>}
            ...
            <div className="items-center mt-6 md:mt-0 flex flex-col">
              ...
              <ul className=" space-y-2 text-gray-400">
                <li className="hover:text-white cursor-pointer duration-300">
                 E-mail- coursehaven@gmail.com
                </li>
                <li className="hover:text-white cursor-pointer duration-300">
                Contact-Us- +91 9007900810
                </li>
                <li className="hover:text-white cursor-pointer duration-300">
